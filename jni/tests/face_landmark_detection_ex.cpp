...
int main(int argc, char** argv)
{
    try
    {
        ...
        // Limit minimal detected face size so you can downscale input image several times to skip small faces.
        unsigned min_face_size = 200; // px
        //double scale = 80.0 / min_face_size;
        // if scale is 2.5, it will be faster 2.5x , but the landmark will not fix well sometimes
        double scale = 1.0;
